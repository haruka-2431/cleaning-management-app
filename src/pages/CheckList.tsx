...
const CheckList = ({ cleaningData, onBackToSelect }: CheckListProps) => {
  ...
  console.log('onBackToSelect:', onBackToSelect);
  ...
  const resetToLogin = () => {
    ...
    onBackToSelect(); // 親コンポーネントの関数を呼び出し
  };
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Header title="チェックリスト・報告書" onBackClick={onBackToSelect} />
      {/* 固定題目 */}
