...
const ReportTable = ({ reports, onOpenDetail }: ReportTableProps) => {
  return (
    <div className="mt-24">
      <div className="border-gray-200 rounded-lg mt-24">
        <div className="bg-white border-b border-gray-200 py-4 sm:py-6 px-4 text-sm lg:text-[16px] font-bold text-gray-400 sticky top-[120px] sm:top-[150px] lg:top-[165px] z-30 grid grid-cols-[1fr_1fr_2fr_80px] lg:grid-cols-[1fr_1fr_1fr_1fr_2fr_2fr_80px] gap-4">
          <div>担当者</div>
